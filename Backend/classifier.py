...
Fine-tuned model support:
  Set CLASSIFIER_MODEL_PATH=Backend/models/fine_tuned_classifier in .env
  after running: python Research/training/train_classifier.py --epochs 5 --eval
...
# Set CLASSIFIER_MODEL_PATH in .env after running Research/training/train_classifier.py
