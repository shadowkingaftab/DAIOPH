...
Implement a **multi-tier memory system** (`Backend/memory/`) inspired by cognitive science:
...
1. **Consolidation pipeline** (`Backend/memory/consolidation/`): periodically promotes short-term → episodic → semantic, with deduplication and importance scoring
