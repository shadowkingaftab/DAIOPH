...
Adopt a **kernel-based architecture** (`Backend/core/kernel/`) with:
...
4. **Protocol-based contracts** (`Backend/core/contracts/protocols.py`) that all subsystems implement
