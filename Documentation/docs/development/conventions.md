...
4. **Contracts first**: New subsystems define protocols in `Backend/core/contracts/`
...
- Raise typed errors from `Backend/core/errors/`
...
- Test files mirror source structure: `Quality/tests/unit/test_<module>.py`
- Test classes: `Test<Feature>`
- Test methods: `test_<behavior>`
- Use fixtures from `Quality/tests/fixtures/`
...
- Branch naming: `feature/<name>`, `fix/<name>`, `Documentation/docs/<name>`
...
- Public APIs documented in `Documentation/docs/api/`
- Architecture decisions in `Documentation/docs/decisions/` (ADRs)
