...
```bash
python Operations/scripts/setup/setup.py
python Operations/scripts/setup/initialize_data.py
```

### 5. Download Models (Optional)

```bash
python Operations/scripts/setup/install_models.py
```

### 6. Start Development Server

```bash
python Operations/scripts/development/dev_server.py
```
...
# Unit tests only
pytest Quality/tests/unit/

# With coverage
pytest --cov=. Quality/tests/
```
