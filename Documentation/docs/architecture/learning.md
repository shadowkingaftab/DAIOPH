...
### Continual Learning (`Backend/learning/continual/`)
...
### Adaptation (`Backend/learning/adaptation/`)
...
### Feedback (`Backend/learning/feedback/`)
...
### Training (`Backend/learning/Research/training/`)
- **Trainer**: Local fine-tuning pipelines
- Supports LoRA/PEFT for efficient adaptation

### Evolution (`Backend/learning/evolution/`)
