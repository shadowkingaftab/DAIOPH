...
## API Security (`Backend/APIs/rest/middleware.py`)
...
## Injection Defense (`Quality/tests/Backend/security/test_injection.py`)

- SQL injection: Parameterized queries only
- XSS: Output encoding in web interfaces
- Prompt injection: Intent schema validation, instruction hierarchy

## Federated Privacy (`Backend/federated/privacy/`)
