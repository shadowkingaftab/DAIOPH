...
### Desktop (`Backend/os_layer/desktop/`)
...
### Filesystem (`Backend/os_layer/filesystem/`)
...
### Applications (`Backend/os_layer/applications/`)
...
### Automation (`Backend/os_layer/automation/`)
...
### System (`Backend/os_layer/system/`)
