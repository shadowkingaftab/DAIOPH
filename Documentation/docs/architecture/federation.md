...
## Client Components (`Backend/federated/client/`)
...
## Server Components (`Backend/federated/server/`)
...
## Privacy (`Backend/federated/privacy/`)
...
## Reputation & Trust (`Backend/federated/reputation/`)
...
## Protocol (`Backend/federated/protocol/`)
...
See `Operations/configs/Backend/federated/client.yaml` and `Operations/configs/Backend/federated/server.yaml`.