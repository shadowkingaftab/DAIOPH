...
### Boot (`Backend/core/kernel/boot.py`)
...
### Runtime (`Backend/core/kernel/runtime.py`)
...
### Event Loop (`Backend/core/kernel/event_loop.py`)
...
All subsystems implement protocols defined in `Backend/core/contracts/protocols.py`:
...
Errors are categorized in `Backend/core/errors/`:
