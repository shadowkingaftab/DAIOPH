...
### Intent Engine (`Backend/intelligence/intent/`)
...
### Reasoning Engine (`Backend/intelligence/reasoning/`)
...
### Cognition (`Backend/intelligence/cognition/`)
...
### State Management (`Backend/intelligence/state/`)
...
- **Confidence score** (`Backend/intelligence/liquid/confidence.py`): 0.0–1.0
- **Uncertainty estimate** (`Backend/intelligence/liquid/uncertainty.py`): epistemic + aleatoric
