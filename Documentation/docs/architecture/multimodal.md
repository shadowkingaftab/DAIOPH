...
## Input Processing (`Backend/multi_modal/input/`)
...
## Speech (`Backend/multi_modal/speech/`)
...
## Vision (`Backend/multi_modal/vision/`)
...
## Video (`Backend/multi_modal/video/`)
...
## Documents (`Backend/multi_modal/documents/`)
