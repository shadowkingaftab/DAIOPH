...
|------------------|----------------|
| Adaptive dynamics | `Backend/intelligence/liquid/liquid_engine.py` |
| State fluidity | `Backend/intelligence/liquid/liquid_state.py` |
| Learning rate modulation | `Backend/intelligence/liquid/plasticity.py` |
| Forgetting prevention | `Backend/intelligence/liquid/stability.py` |
| Calibrated confidence | `Backend/intelligence/liquid/confidence.py` |
| Uncertainty decomposition | `Backend/intelligence/liquid/uncertainty.py` |
...
Metrics tracked in `Research/evaluation/Backend/intelligence/` and `Research/evaluation/Backend/learning/`:
