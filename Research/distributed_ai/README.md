...
- `Backend/network/discovery/discovery.py` — peer discovery
- `Backend/network/peer/peer_manager.py` — peer lifecycle
- `Backend/network/synchronization/synchronizer.py` — state sync
- `Backend/network/synchronization/conflict_resolution.py` — merge strategies
- `Backend/network/distributed/distributed_memory.py` — shared memory
- `Backend/network/distributed/distributed_execution.py` — cross-device execution

## Related Documentation

- Architecture: `Documentation/docs/architecture/system.md`
- Experiments: [experiments.md](experiments.md)

## Getting Started

```bash
python Research/experiments/Backend/federated/run_distributed_memory_test.py --peers 3
```
