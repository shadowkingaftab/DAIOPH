...
**Protocol**:
```bash
python Research/experiments/continual_Backend/learning/run_forgetting_study.py --method finetune
python Research/experiments/continual_Backend/learning/run_forgetting_study.py --method ewc
python Research/experiments/continual_Backend/learning/run_forgetting_study.py --method replay
python Research/experiments/continual_Backend/learning/run_forgetting_study.py --method lora_replay
```
