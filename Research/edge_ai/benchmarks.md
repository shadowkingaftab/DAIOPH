...
Results are collected via `Research/benchmarks/devices/benchmark.py`. Each entry includes hardware specs, software versions, and methodology.
...
```bash
python Research/benchmarks/devices/benchmark.py --device <profile> --iterations 100
python Operations/scripts/benchmarking/compare.py --baseline results/v1.json