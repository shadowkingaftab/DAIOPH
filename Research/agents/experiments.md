...
python Research/experiments/Backend/agents/run_topology_comparison.py --topology flat
python Research/experiments/Backend/agents/run_topology_comparison.py --topology market
```
