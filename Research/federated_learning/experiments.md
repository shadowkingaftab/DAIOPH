...
**Protocol**:
```bash
python Research/experiments/Backend/federated/run_dp_tradeoff.py --epsilon 0.5
python Research/experiments/Backend/federated/run_dp_tradeoff.py --epsilon 1.0
python Research/experiments/Backend/federated/run_dp_tradeoff.py --epsilon 4.0
```
