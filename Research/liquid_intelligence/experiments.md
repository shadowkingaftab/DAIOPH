...
**Protocol**:
```bash
python Research/experiments/liquid/run_adaptation_study.py --schedule constant
python Research/experiments/liquid/run_adaptation_study.py --schedule exp_decay
python Research/experiments/liquid/run_adaptation_study.py --schedule cosine
python Research/experiments/liquid/run_adaptation_study.py --schedule adaptive
```
